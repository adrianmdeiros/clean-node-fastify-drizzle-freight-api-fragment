...
CREATE TABLE `__new_cities` (
	`id` text PRIMARY KEY DEFAULT '6nLJhJIShgMSOCalFIvJ8' NOT NULL,
	`name` text NOT NULL,
	`uf` text NOT NULL,
...
CREATE TABLE `__new_clients` (
	`id` text PRIMARY KEY DEFAULT '_MysDIzXpj6QqHChgP6mr' NOT NULL,
	`name` text NOT NULL,
...
CREATE TABLE `__new_freights` (
	`id` text PRIMARY KEY DEFAULT '0AUAo24CMK7s_HtCOPGG9' NOT NULL,
