...
CREATE TABLE `__new_cities` (
	`id` text PRIMARY KEY DEFAULT 'oiNoFKLro5pXfNzJ7M4fu' NOT NULL,
	`name` text NOT NULL,
	`uf` text NOT NULL,
...
CREATE TABLE `__new_clients` (
	`id` text PRIMARY KEY DEFAULT 'xnJcpT3OF7dd0FWwwLvaq' NOT NULL,
	`name` text NOT NULL,
...
CREATE TABLE `__new_freights` (
	`id` text PRIMARY KEY DEFAULT '1Mtp3pzS8FgLygH5IbpIb' NOT NULL,
