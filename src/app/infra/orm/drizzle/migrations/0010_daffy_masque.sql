...
CREATE TABLE `__new_cities` (
	`id` text PRIMARY KEY DEFAULT 'ixhUvY5UtBTbR1WjygT9B' NOT NULL,
	`name` text NOT NULL,
	`uf` text NOT NULL,
...
CREATE TABLE `__new_clients` (
	`id` text PRIMARY KEY DEFAULT 'P62SrYQjnbl-s2i1k5sP8' NOT NULL,
	`name` text NOT NULL,
...
CREATE TABLE `__new_freights` (
	`id` text PRIMARY KEY DEFAULT 'hrgHPOOJFeHrdaDII0Uk2' NOT NULL,
